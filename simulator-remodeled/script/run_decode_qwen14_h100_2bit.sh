...
-quantized_weight_compression_bits 2 \
-quantized_weight_region_file /tmp/weight_regions_qwen14b.json \
| tee /home/qshao/Project/Fun/modern-gpu-simulator-micro-2025/simulator-remodeled/log/decode/sim_decode_qwen14_2bit.log
